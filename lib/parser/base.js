 ...
 * @Last Modified time: 2018-03-19 19:35:57
 */
...
const parseKnexSchema = function (knex, tableName, fields) {
    knex.createTableIfNotExists(tableName, function (t) {
...
module.exports = class {
    ...
    parseSchema(cls, data, options) {
        ...
        let fields = options.schema.fields, dbType = options.schema.dbType;
        parseKnexSchema(cls, tableName, fields);
        return cls;
    }
    /**
     * 
    ...
    buildUPDATE(cls, data, options) {
        ...
        this.knexClient.parseData(this.knexClient, data, options);
        return this.knexClient.parseWhere(this.knexClient, data, options);
    }
    /**
     * 
     * 
    ...
    buildINCREMENT(cls, data, options) {
        if (options.targetField && data[options.targetField]) {
            cls.increment(options.targetField, data[options.targetField]);
    ...
    buildDECREMENT(cls, data, options) {
        if (options.targetField && data[options.targetField]) {
            cls.decrement(options.targetField, data[options.targetField]);
            delete data[options.targetField];
        }
        this.knexClient = cls.from(options.table);
        this.knexClient.parseData(this.knexClient, data, options);
