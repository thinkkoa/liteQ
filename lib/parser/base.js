 ...
 * @Last Modified time: 2018-03-09 14:26:54
 */
...
const parseKnexSchema = function (field, value, dbType) {
    let str = '', primary = false, defaultVal;
    if (value.pk !== undefined && value.pk === true) {
        primary = true;
    }
    //默认值
    if (value.defaults !== undefined) {
        defaultVal = value.defaults;
    }
